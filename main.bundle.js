...
var operators_1 = __webpack_require__(104);
__webpack_require__(204);
var state_1 = __webpack_require__(205);
var observables_1 = __webpack_require__(206);
var htmlHelpers_1 = __webpack_require__(207);
...
var navigationElement = document.querySelector('.navigationElement');
var filterElement = document.querySelector('.filterElement');
htmlHelpers_1.openModalHandler();
htmlHelpers_1.createPaginationControl(navigationElement);
htmlHelpers_1.createFilterControl(filterElement);
var statusElement = document.querySelector('.statusElement');
var genderElement = document.querySelector('.genderElement');
var initialDataLoading$ = ajax_1.ajax.get(state.getSourceForCurrentPage())
...
var navigation$ = rxjs_1.fromEvent(navigationElement, 'click')
    ...
    return Object.assign(new state_1.State(), state);
}), operators_1.mergeMap(function () { return ajax_1.ajax.get(state.getSourceForCurrentPage()).pipe(operators_1.map(function (res) {
    var response = res.response;
    if (response.results) {
        state.setCharacters(response.results);
    }
...
var search$ = rxjs_1.fromEvent(inputElement, 'change')
    .pipe(operators_1.map(function (event) {
    var element = event.target;
    state.setFilter('search', element.value);
    return Object.assign(new state_1.State(), state);
}));
var statusFilter$ = rxjs_1.fromEvent(statusElement, 'change')
    .pipe(operators_1.map(function (event) {
    var element = event.target;
    state.setFilter('status', element.value);
    return Object.assign(new state_1.State(), state);
}));
var statusGender$ = rxjs_1.fromEvent(genderElement, 'change')
    .pipe(operators_1.map(function (event) {
    var element = event.target;
    state.setFilter('gender', element.value);
    return Object.assign(new state_1.State(), state);
}));
var application$ = rxjs_1.merge(initialDataLoading$, navigation$, search$, statusFilter$, statusGender$);
application$.subscribe(function (state) {
    if (state != prevState) {
        htmlHelpers_1.createCharactersList(containerElement, state.getCharacters());
        observables_1.createObservables();
        prevState = state;
    }
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _internal_observable_dom_ajax__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(100);
...
/* harmony import */ var _internal_observable_dom_AjaxObservable__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(101);
...
/* harmony import */ var _AjaxObservable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(101);
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5);
/* harmony import */ var _util_root__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(102);
/* harmony import */ var _Observable__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2);
/* harmony import */ var _Subscriber__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4);
...
var State = /** @class */ (function () {
    function State() {
        ...
        this.source = 'https://rickandmortyapi.com/api/character/';
        this.characters = [];
    }
    State.prototype.setFilter = function (filter, value) {
        switch (filter) {
            case ('search'): {
    ...
    State.prototype.getSourceForCurrentPage = function () {
        return this.source + "?page=" + this.page;
    };
    State.prototype.navToPrevPage = function () {
        if (this.page > 1) {
            this.page -= 1;
        }
    };
    State.prototype.navToNextPage = function () {
        if (this.page < this.pages) {
            this.page += 1;
        }
    };
    State.prototype.setPagesNumber = function (pages) {
        this.pages = pages;
    };
    State.prototype.setCharacters = function (characters) {
        this.characters = characters;
    };
    State.prototype.getCharacters = function () {
        var _this = this;
        return this.characters.filter(function (character) {
            var withSelectedStatus = character.status === _this.filters.status || !_this.filters.status;
            var withSelectedGender = character.gender === _this.filters.gender || !_this.filters.gender;
            var withSearchedName = character.name.indexOf(_this.filters.search) !== -1;
...
function createObservables() {
    ...
    characters.forEach(function (character) {
        rxjs_1.fromEvent(character, 'click')
            .pipe(operators_1.map(function (event) {
            event.preventDefault();
            var element = event.target;
            return element.href;
        }), operators_1.mergeMap(function (url) { return ajax_1.ajax.get(url).pipe(operators_1.map(function (res) {
            var response = res.response;
            return response;
        })); }), operators_1.mergeMap(function (characterData) { return ajax_1.ajax.get(characterData.location.url).pipe(operators_1.map(function (res) {
            var locationData = res.response;
            return {
            ...
            var characterData = _a.characterData, locationData = _a.locationData;
            htmlHelpers_1.onCharacterClick({ characterData: characterData, locationData: locationData });
        });
    });
}
exports.createObservables = createObservables;
...
Object.defineProperty(exports, "__esModule", { value: true });
function createCharactersList(containerElement, characters) {
    containerElement.innerHTML = '';
    characters.forEach(function (character) {
        var characterTag = document.createElement('div');
        var characterLinkTag = document.createElement('a');
...
exports.createCharactersList = createCharactersList;
function createPaginationControl(containerElement) {
    var navigationControl = document.createElement('div');
...
exports.createPaginationControl = createPaginationControl;
function setValueTextToOption(option, value, text) {
    option.value = value;
    option.text = text;
}
function createFilterControl(containerElement) {
    ...
    var genderOptionAll = document.createElement('option');
    var genderOptionFemale = document.createElement('option');
    var genderOptionMale = document.createElement('option');
    var genderOptionUnknown = document.createElement('option');
    var statusOptionAlive = document.createElement('option');
    var statusOptionAll = document.createElement('option');
    var statusOptionDead = document.createElement('option');
    var statusOptionUnknown = document.createElement('option');
...
exports.createFilterControl = createFilterControl;
...
exports.openModalHandler = openModalHandler;
function onCharacterClick(data) {
    var characterData = data.characterData, locationData = data.locationData;
    var modal = document.getElementById("modalWrapper");
    modal.innerHTML = '';
    var characterInfo = createCharacterInfo(characterData);
    var locationInfo = createLocationInfo(locationData);
    modal.appendChild(characterInfo);
    modal.appendChild(locationInfo);
    var btn = document.getElementById("myBtn");
    btn.click();
}
exports.onCharacterClick = onCharacterClick;
...
exports.createCharacterInfo = createCharacterInfo;
